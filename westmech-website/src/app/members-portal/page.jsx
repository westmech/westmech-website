...
const page = () => {
  ...
  function handleNavigate(userType) {
    if (userType == "parent") {
      ...
      router.push("members-portal/students-portal");
    }
  }
  return (
    <main
    ...
    >
      ...
      >
        <div className="flex flex-col w-[80%]">
          ...
          <p className="text-[18px]  sm:text-[24px] mb-5">
            Select a sign in option to get started
          </p>
          <ProfileButton
            onClick={() => handleNavigate("parent")}
            className="mb-5"
            user="Parent"
            iconSrc="/login/person.svg"
            colour={darkblue}
          ></ProfileButton>
          <ProfileButton
            onClick={() => handleNavigate("student")}
            user="Student"
            iconSrc="/login/student.svg"
            colour={purple}
          ></ProfileButton>
          <p className="text-[18px] sm:text-[24px] mb-1">
            Don't have an account?
          </p>
          <a
            href="#"
            className="text-[18px] sm:text-[24px] font-medium text-[#017FE0] hover:text-[black] cursor-pointer inline-block"
          >
            Ask your coach
          </a>
        </div>
